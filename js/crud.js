...
function InsertarDatos(data) {
    ...
    cell1 = Fila.insertCell(0).innerHTML = data.nom
    cell2 = Fila.insertCell(1).innerHTML = data.ape
    cell3 = Fila.insertCell(2).innerHTML = data.pais
    cell3 = Fila.insertCell(3).innerHTML = `<input class="submit" type="button" onClick="Editarr(this)" value="Editar" >
